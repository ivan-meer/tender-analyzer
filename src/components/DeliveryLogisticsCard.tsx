...
export const DeliveryLogisticsCard: React.FC<DeliveryLogisticsCardProps> = ({ deliveryInfo }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 border-2 border-indigo-200 dark:border-indigo-900/60 rounded-3xl shadow-sm overflow-hidden transition-all duration-200">
      {/* Top Banner Header */}
      ...
      <div className="p-5 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-6 space-y-4">
            <div className="flex items-center gap-2 text-xs font-extrabold text-indigo-950 dark:text-indigo-200 uppercase tracking-wider">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-slate-50 dark:from-indigo-950/40 dark:to-slate-800/80 border-2 border-indigo-200 dark:border-indigo-800/80 rounded-2xl p-4 space-y-2 relative overflow-hidden">
            ...
            {deliveryInfo.deliveryScheduleNotice && (
              <div className="bg-amber-50/80 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-2xl p-3.5 flex items-start gap-3">
              ...
              {addresses.map((addr, idx) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="p-2 bg-rose-100 dark:bg-rose-950 text-rose-700 dark:text-rose-300 rounded-xl shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2 border-t border-slate-200 dark:border-slate-800">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-4 space-y-1.5">
          ...
          {/* Risk Warning Notice */}
          <div className="bg-red-50/80 dark:bg-red-950/40 border border-red-200 dark:border-red-900 rounded-2xl p-4 space-y-1.5">
            <div className="flex items-center gap-1.5 text-xs font-extrabold text-red-900 dark:text-red-300">
