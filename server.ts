...
- Если тип процедуры относится к 44-ФЗ (44_FZ_AUCTION, 44_FZ_QUOTATION, 44_FZ_TENDER) или в документах упомянут ФЗ № 44:
  ...
  3. **Национальный режим (ПП РФ № 1875):** Проверяй условия ограничения и запрета допуска иностранных товаров, необходимость указания реестровых номеров ГИСП/РЭП Минпромторга и набранных баллов.
  4. **ЕРУЗ ЕИС и Электронное актирование:** Проверяй требования аккредитации в ЕРУЗ, предоставления независимой гарантии из реестра ЕИС и приемки через личный кабинет ЕИС (электронный УПД).
  5. **Односторонний отказ по 44-ФЗ:** Оценивай риски размещения решения об одностороннем отказе в ЕИС и внесения в РНП на 2 года.
